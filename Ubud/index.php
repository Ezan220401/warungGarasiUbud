...
<html lang="en">
 ...
 .dafMenu .row{
  ...
  <body>
    ...
    <!-- navbar start -->
    <nav class="navbar">
        <a href="#" class="navbar-logo">Warung Garasi<span> Ubud</span>.</a>
    ...
    <section id="dafMenu" class="dafMenu">
      ...
      <?php $i=1; ?>
       <?php foreach($menunya as $baris): 
        ...
        <img class="menu-card-img" src="img/<?= $baris["gambar"]; ?>">
        <h3 class="menu-card-title"><?= $baris["nama_menu"] ," | ", $baris["harga"], "K IDR"?></h3>
...
<section id="contact" class="contact">
    ...
    <footer>
      ...
      <div class="credit">
        ...
        <p>Created by <a href="admin/login.php"><b>Ezra JFP</b></a>| &copy; 2023.</p>
      </div>
    </footer>
    <!-- footer end -->
